...
<fieldset >
<legend>Contribute Ideas</legend>
...
<div class='container'>
    <label for='name' >Contributor's Name*: </label><br/>
...
<div class='container'>
    <label for='ideaname' >Idea Name*:</label><br/>
    <input type='text' name='ideaname' id='ideaname' value='<?php echo $formproc->SafeDisplay('ideaname') ?>' maxlength="50" /><br/>
    <span id='contactus_ideaname_errorloc' class='error'></span>
</div>

<div class='container'>
    <label for='message' >Idea Benefits:</label><br/>
    <span id='contactus_message_errorloc' class='error'></span>
    <textarea rows="10" cols="50" name='message' id='message'><?php echo $formproc->SafeDisplay('message') ?></textarea>
</div>

<div class='container'>
    <label for='photo' >Upload a file:</label><br/>
...
// <![CDATA[
    ...
    frmvalidator.addValidation("ideaname","req","Please provide your Idea Name");
